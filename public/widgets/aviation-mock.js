...
export const MOCK_AVIATION = {
  metar: [
    ...
    { icao: 'KOLM', station: { name: 'Olympia Regional' }, flight_category: 'MVFR',
      wind: { degrees: 200, speed: { kts: 6 } }, visibility: { miles: 5 },
      clouds: [{ code: 'BKN', feet: 1800 }], raw_text: 'KOLM 011853Z 20006KT 5SM BR BKN018 13/11 A3011' },
